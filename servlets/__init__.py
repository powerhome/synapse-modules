...
class Module:
    ...
    def room_register_servlets(self, hs: "HomeServer", http_server: HttpServer) -> None:
        if self.crypto_enabled:
            ConnectRoomEventServlet(hs).register(http_server)
            ConnectRoomEventContextServlet(hs).register(http_server)
    ...
    def sync_register_servlets(self, hs: "HomeServer", http_server: HttpServer) -> None:
        if self.crypto_enabled:
            ...
            ConnectSlidingSyncRestServlet(hs).register(http_server)
